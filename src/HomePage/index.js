...
<div className={styles.container}>
    <div className={styles.parallax}>
        ...
        <h1 className="text-6xl ">Welcome to the ASM SERVICES</h1>
    ...
    height: '100vh'
        ...
        <div className={`${styles.intro_title} `}><div className="text-6xl font-serif font-semibold pr-20 ">Welcome to ASM SERVICES</div></div>
