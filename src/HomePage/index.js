...
<div className={styles.container}>
    ...
    <div className={`${styles.intro_block} pl-56  text-lg font-medium items-center text-wrap `} style={{
    ...
    height: '100vh'
        ...
        <div className={`${styles.intro_body} flex font-serif flex-col text-2xl  `}>
          ...
          <p className="mb-5 text-wrap">From weekend getaways to extended, family-focused itineraries and luxury escapes, when you book with 1000 Mile Travel Vacations you’ll enjoy exemplary service and value for money, delivered by the best team in travel.</p>
